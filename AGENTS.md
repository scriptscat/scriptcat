...
> **Before writing any code, read [`docs/develop/README.md`](docs/develop/README.md)** — the development spec (commands,
...
> in `DEVELOP.md`, and deep internals in [`docs/architecture/README.md`](docs/architecture/README.md).

> **To manually verify a feature actually works, read [`docs/verification/README.md`](docs/verification/README.md)** — drive
...
> [`docs/develop/README.md`](docs/develop/README.md); the design system (color tokens, components, layout/motion/state
> patterns, new-page recipe) lives in [`docs/design/README.md`](docs/design/README.md) — read it before building any page.

## Engineering Principles

These are non-negotiable and apply to every change, regardless of what `docs/develop/README.md` says about mechanics.
...
- **TDD/BDD first.** Write failing tests **before** implementation, using BDD-style Chinese `describe`/`it` titles. (Runner, mocks, and how to run tests are in `docs/develop/README.md`.)
...
> **Deep dive:** [`docs/architecture/README.md`](docs/architecture/README.md) — the human-facing internals guide for

...
The shadcn primitives live in [`src/pages/components/ui/`](../../src/pages/components/ui/) — `new-york` style, CSS variables enabled, no class prefix (`components.json`). Follow the [`develop.md` § UI](../develop.md#ui) for implementation rules; this section covers what exists and how to choose.

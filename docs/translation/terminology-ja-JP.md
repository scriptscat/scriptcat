...
用例の参照元：`src/locales/ja-JP/*.json`、`docs/README_ja.md`、`docs/architecture/README.md`
...
| Tampermonkey compatibility | `Tampermonkey 互換ユーザースクリプト` / `Tampermonkey のスクリプト` | `docs/README_ja.md`, `docs/architecture/README.md` | 互換性を説明する場合に使用し、一般名やカテゴリ名を一律に置き換えないでください。 |

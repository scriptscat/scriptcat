...
Usage sources reviewed: `src/locales/en-US/*.json`, `README.md`, `docs/architecture/README.md`
...
| Tampermonkey compatibility | `Tampermonkey-compatible userscript` / `Tampermonkey script` | `README.md`, `docs/architecture/README.md` | Use this wording when compatibility is the point; do not turn every generic userscript label into a Tampermonkey label. |

...
盤點來源：`src/locales/zh-TW/*.json`、`docs/README_zh-TW.md`、`docs/architecture/README.md`
...
| `Tampermonkey 腳本` | 僅在說明相容性時使用；不要把所有 `使用者腳本` 泛稱或 `普通腳本` 分類改成 Tampermonkey 標籤。 | `docs/README_zh-TW.md`, `docs/architecture/README.md` |

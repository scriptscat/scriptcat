...
用例参考来源：`src/locales/zh-CN/*.json`、`docs/README_zh-CN.md`、`docs/architecture/README.md`
...
| Tampermonkey compatibility | `油猴脚本` / `兼容 Tampermonkey 的用户脚本` | `docs/README_zh-CN.md`, `docs/architecture/README.md` | 仅在说明兼容性时使用，不把所有“用户脚本”泛称或“普通脚本”分类改写为油猴脚本。 |

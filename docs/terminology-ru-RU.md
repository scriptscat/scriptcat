...
Проверенный источник употребления: `src/locales/ru-RU/translation.json`
...
| script gallery / market | `Галерея скриптов` / `Магазин скриптов` | `script_gallery`, `guide_script_list_title` | Выбирать название фактического раздела назначения. |

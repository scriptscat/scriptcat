[English Contribution Guidelines](../CONTRIBUTING.md) / [Руководство на русском](./CONTRIBUTING_RU.md)
...
**安全漏洞是例外——请勿提交公开 Issue。** 请按照我们的[安全策略](../SECURITY.md)私密上报，以便在公开披露前先完成修复。

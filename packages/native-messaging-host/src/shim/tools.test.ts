...
describe("TOOL_INPUT_SCHEMAS - zod .strict() 校验", () => {
...
describe("visibleTools - 按 scope 过滤工具目录", () => {
...
describe("TOOL_TO_ACTION / TOOL_REQUIRED_SCOPE - 映射内部一致", () => {
...
describe("TOOL_DESCRIPTIONS - 写工具必须声明人工批准契约", () => {
...
describe("toToolResult - 结构化输出，不做 Markdown 拼接（反注入）", () => {

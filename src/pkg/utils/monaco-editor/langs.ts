...
* * * * once(1-5) Раз в неделю, только с понедельника по пятницу`.replace(/\n/g, "<br>"),
  ...
  "tr-TR": {
    ...
    grantValuePrompts: grantValuePromptsTrTR,
    prompt: {
      name: "Betik adı",
...
* * * * once(1-5) Haftada bir kez, yalnızca Pazartesi-Cuma günleri çalışır`.replace(/\n/g, "<br>"),
  ...
  "pt-BR": {
    ...
    grantValuePrompts: grantValuePromptsPtBR,
    prompt: {
      name: "Nome do script",
      ...
      antifeature:
        `Relacionado aos mercados de scripts: funcionalidades indesejadas devem incluir este valor de descrição

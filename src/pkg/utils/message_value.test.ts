...
describe.concurrent("encodeMessage / decodeMessage", () => {
  it.concurrent("应能正确编码与解码包含 undefined 和 null 的对象", () => {
    const input = {
      a: undefined,
      b: null,
      c: 1,
  ...
  it.concurrent("数组中的 undefined 与 null 可被正确往返且索引不丢失", () => {
  ...
  it.concurrent("普通字符串包含 'undefined' 或 'null' 时不应被误替换", () => {
    const input = {
      s1: "undefined",
      s2: "null",

...
import type { OperationKind, OperationStatus, BridgeErrorCode } from "@App/app/service/service_worker/mcp/types";

// 待批操作：绑定请求当时的内容哈希/目标脚本状态等字段全部保留，执行器（McpApprovalService.decide）

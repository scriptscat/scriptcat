  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="flex items-center gap-1.5 px-4 pb-1.5 shrink-0">
        ...
        <button
          className="flex items-center gap-1 px-2.5 py-1 text-xs border rounded-sm border-destructive text-destructive"
          ...
          return (
            <Surface key={item.uuid} className="flex flex-col gap-2 p-3.5">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-[11px] ${urgent ? "font-semibold text-destructive" : "text-muted-foreground"}`}>
                  {left === null

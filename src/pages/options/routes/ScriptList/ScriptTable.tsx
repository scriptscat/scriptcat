...
const FilterDropdown = React.memo(
  ({
    ...
    return (
      <div className="arco-table-custom-filter uno-flex uno-flex-row uno-gap-2">
        <Input.Search
          ref={inputRef}
          size="small"
          searchButton
    ...
    () =>
      [
        ...
        },
        {
          ...
          className: "uno-max-w-[240px] uno-min-w-[100px]",
  ...
  return (
    <DraggableContext.Provider value={draggableContextValue}>
      {showAction && (
        <Card>
          <div
            className="uno-flex uno-flex-row uno-justify-between uno-items-center"
            style={{
              padding: "8px 6px",
            }}
          >

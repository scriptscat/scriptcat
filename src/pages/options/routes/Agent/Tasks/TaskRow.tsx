...
import { StatusDot, CapabilityTag } from "../components/tags";
...
export function TaskRow({
  ...
  if (isMobile) {
    return (
      <AgentEntityCard density="compact" disabled={!task.enabled} className="gap-2.5">
  ...
  return (
    <AgentEntityCard layout="row" disabled={!task.enabled} className="rounded-[10px] px-[18px] py-3.5">
      {avatar}

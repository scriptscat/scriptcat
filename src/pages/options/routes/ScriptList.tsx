...
import { IconClockCircle, IconDragDotVertical, IconEdit, IconLink, IconMenu, IconSearch, IconUserAdd } from "@arco-design/web-react/icon";
import {
  RiDeleteBin5Fill,
  RiPencilFill,
  RiPlayFill,
...
const DragHandle = () => {
  ...
  if (!sortable) return <IconDragDotVertical
    style={{
      cursor: "move",
    }}
  />
